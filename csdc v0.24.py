...
def initialize_weeks():
    with get_session() as s:
        ...
        weeks.append(CsdcWeek(
                ...
                species = "Vp",
                background = "As",
                gods = ("Dithmenos", "Kikubaaqudgha", "Qazlal"),
                start = datetime.datetime(2020,1,31, tzinfo=datetime.timezone.utc),
                end = datetime.datetime(2018,2,7, tzinfo=datetime.timezone.utc)))
        weeks.append(CsdcWeek(
                number = "2",
                species = "Te",
                background = "Tm",
                gods = ("Ashenzari", "Nemelex Xobeh", "Vehumet"),
                start = datetime.datetime(2020,2,7, tzinfo=datetime.timezone.utc),
                end = datetime.datetime(2020,2,14, tzinfo=datetime.timezone.utc)))
        weeks.append(CsdcWeek(
                number = "3",
                species = "Mi",
                background = "Su",
                gods = ("Ru", "Sif Muna", "The Shining One"),
                start = datetime.datetime(2020,2,14, tzinfo=datetime.timezone.utc),
                end = datetime.datetime(2020,2,21, tzinfo=datetime.timezone.utc)))
        weeks.append(CsdcWeek(
                number = "4",
                species = "Gn",
                background = "CK",
                gods = ("Xom", "GOD_NO_GOD", "GOD_NO_GOD"),
                start = datetime.datetime(2020,2,21, tzinfo=datetime.timezone.utc),
                end = datetime.datetime(2020,2,28, tzinfo=datetime.timezone.utc)))
        weeks.append(CsdcWeek(
                number = "5",
                species = "VS",
                background = "Ar",
                gods = ("Fedhas", "Hepliaklqana", "Makhleb"),
                start = datetime.datetime(2020,2,28, tzinfo=datetime.timezone.utc),
                end = datetime.datetime(2020,3,6, tzinfo=datetime.timezone.utc)))
