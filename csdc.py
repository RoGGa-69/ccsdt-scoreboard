...
def initialize_weeks():
    with get_session() as s:
        ...
        weeks.append(CsdcWeek(
                ...
                species = "At",
                background = "Hu",
                gods = ("Ashenzari", "Jiyva", "Yredelemnul"),
        ...
        weeks.append(CsdcWeek(
                ...
                species = "Op",
                background = "Su",
                gods = ("Cheibriados", "Jiyva", "Yredelemnul"),
        ...
        weeks.append(CsdcWeek(
                ...
                species = "Mf",
                background = "Fi",
                gods = ("Okawaru", "Jiyva", "Yredelemnul"),
        ...
        weeks.append(CsdcWeek(
                ...
                species = "Ds",
                background = "IE",
                gods = ("Sif Muna", "Jiyva", "Yredelemnul"),
